...
parser = argparse.ArgumentParser(description="Get plots by insurance")
parser.add_argument(
    "--model",
    type=str,
...
plt.savefig(
    f"data/results/subgroup_insurance_{args.model}_{args.yob_cutoff}_{args.followup_cutoff}.png"
)
