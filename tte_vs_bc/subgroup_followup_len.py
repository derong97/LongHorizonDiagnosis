...
parser = argparse.ArgumentParser(description="Get plots by follow up length")
parser.add_argument(
    "--model",
    type=str,
...
X_LABEL = "Follow-up length (years)"
...
plt.savefig(
    f"data/results/subgroup_followup_len_{args.model}_{args.yob_cutoff}_{args.followup_cutoff}.png"
)
