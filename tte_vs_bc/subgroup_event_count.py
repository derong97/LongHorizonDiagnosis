...
parser = argparse.ArgumentParser(description="Get plots by event counts")
parser.add_argument(
    "--model",
    type=str,
...
plt.savefig(
    f"data/results/subgroup_event_count_{args.model}_{args.yob_cutoff}_{args.followup_cutoff}.png"
)
